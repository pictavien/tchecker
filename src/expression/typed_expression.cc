...
namespace tchecker
{
    ...
    std::ostream &
    operator<< (std::ostream &os, enum tchecker::expression_type_t type)
    {
      switch (type)
        {
          case EXPR_TYPE_BAD:
          ...
          case EXPR_TYPE_LOCATION_ID_FORMULA:
            return os << "LOCATION_ID_FORMULA";
          case EXPR_TYPE_LOCATION_LABEL_FORMULA:
    ...
    void
    typed_expression_t::visit (tchecker::typed_expression_visitor_t &v) const
    {
    ...
    void
    typed_var_expression_t::do_visit (tchecker::typed_expression_visitor_t &v) const
    {
      v.visit (*this);
    }
    ...
    void
    typed_bounded_var_expression_t::do_visit (tchecker::typed_expression_visitor_t &v) const
    {
      v.visit (*this);
    }
    ...
    void
    typed_array_expression_t::do_visit (tchecker::typed_expression_visitor_t &v) const
    {
      v.visit (*this);
    }
    ...
    void
    typed_par_expression_t::do_visit (tchecker::typed_expression_visitor_t &v) const
    {
      v.visit (*this);
    }
    ...
    typed_binary_expression_t::left_operand () const
    {
    ...
    tchecker::typed_expression_t const &
    typed_binary_expression_t::right_operand () const
    {
      return dynamic_cast<tchecker::typed_expression_t const &>
    ...
    typed_binary_expression_t::left_operand_clone () const
    {
    ...
    tchecker::typed_expression_t *
    typed_binary_expression_t::right_operand_clone () const
    {
      return dynamic_cast<tchecker::typed_expression_t *>
    ...
    void
    typed_binary_expression_t::do_visit (tchecker::typed_expression_visitor_t &v) const
    {
      v.visit (*this);
    }
    ...
    tchecker::typed_expression_t const &
    typed_unary_expression_t::operand () const
    {
      return dynamic_cast<tchecker::typed_expression_t const &>
    ...
    tchecker::typed_expression_t *
    typed_unary_expression_t::operand_clone () const
    {
      return dynamic_cast<tchecker::typed_expression_t *>
    ...
    void
    typed_unary_expression_t::do_visit (tchecker::typed_expression_visitor_t &v) const
    {
      v.visit (*this);
    }
    ...
    void
    typed_simple_clkconstr_expression_t::do_visit (tchecker::typed_expression_visitor_t &v) const
    {
      v.visit (*this);
    }
    ...
    void
    typed_diagonal_clkconstr_expression_t::do_visit (tchecker::typed_expression_visitor_t &v) const
    {
      v.visit (*this);
    }
    ...
    tchecker::typed_expression_t const &
    typed_ite_expression_t::condition () const
    {
      return dynamic_cast<tchecker::typed_expression_t const &>
    ...
    tchecker::typed_expression_t const &
    typed_ite_expression_t::then_value () const
    {
      return dynamic_cast<tchecker::typed_expression_t const &>
    ...
    tchecker::typed_expression_t const &
    typed_ite_expression_t::else_value () const
    {
      return dynamic_cast<tchecker::typed_expression_t const &>
    ...
    tchecker::typed_expression_t *
    typed_ite_expression_t::condition_clone () const
    {
      return dynamic_cast<tchecker::typed_expression_t *>
    ...
    tchecker::typed_expression_t *
    typed_ite_expression_t::then_value_clone () const
    {
      return dynamic_cast<tchecker::typed_expression_t *>
    ...
    tchecker::typed_expression_t *
    typed_ite_expression_t::else_value_clone () const
    {
      return dynamic_cast<tchecker::typed_expression_t *>
    ...
    void
    typed_ite_expression_t::do_visit (tchecker::typed_expression_visitor_t &v) const
    {
      v.visit (*this);
    }

    /* typed_location_id_expression_t */
    typed_location_id_expression_t::typed_location_id_expression_t (enum tchecker::expression_type_t type,
    ...
    tchecker::expression_t *typed_location_id_expression_t::do_clone () const
    {
      return new tchecker::typed_location_id_expression_t (_type, _process, _process_id, _loc, _loc_id);
    }

    void
    typed_location_id_expression_t::do_visit (tchecker::typed_expression_visitor_t &v) const
    {
      v.visit (*this);
    }
    
    /* typed_location_label_expression_tt */
    typed_location_label_expression_t::typed_location_label_expression_t (enum tchecker::expression_type_t type,
                                                              std::string const &process,
                                                              tchecker::process_id_t process_id,
                                                              std::string const &loc,
                                                              tchecker::label_id_t label_id)
        : tchecker::make_typed_expression_t<tchecker::location_expression_t> (type, process, loc),
          _process_id (process_id), _label_id (label_id)
    {}

    tchecker::expression_t *typed_location_label_expression_t::do_clone () const
    {
      return new tchecker::typed_location_label_expression_t (_type, _process, _process_id, _loc, _label_id);
    }

    void
    typed_location_label_expression_t::do_visit (tchecker::typed_expression_visitor_t &v) const
    {
      v.visit (*this);
    }
    ...
    void
    typed_event_expression_t::do_visit (tchecker::typed_expression_visitor_t &v) const
    {
      v.visit (*this);
    }
